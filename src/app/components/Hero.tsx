    ...
    <section className="py-20">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <motion.a
              href="https://github.com/Isuri2002"
              target="_blank"
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/contact"
                className="inline-block w-full md:w-auto bg-gray-500 text-white px-8 py-3 rounded-lg hover:bg-gray-600 transition-colors"
              >
                Contact Me
              </Link>
            </motion.div>
